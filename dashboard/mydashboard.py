...
with tab1:
    ...
    with col1:
        ...
        sns.barplot(x='weather_condition', y='total_rentals', data=days_df, errorbar=None, hue='weather_condition',
                    palette='pastel', ax=ax)
        ax.set_title("Rata-rata Penyewaan Sepeda Berdasarkan Kondisi Cuaca")
        ax.legend(title='Kondisi Cuaca', labels=['Cerah', 'Mendung', 'Hujan/Salju'])
    ...
    with col2:
        ...
        # Membuat boxplot
        fig, ax = plt.subplots(figsize=(8, 6))
        sns.boxplot(x='weather_condition', y='total_rentals', hue='weather_condition', palette='Set2', data=days_df,
                    ax=ax)
...
with tab1:
    ...
    with col2:
        ...
        fig, ax = plt.subplots(figsize=(12, 6))
        sns.boxplot(x='season', y='total_rentals', hue='season', palette='pastel', data=days_df, ax=ax)
        ax.set_title("Distribusi Penyewaan Sepeda Berdasarkan Musim")
        ax.legend(title='Musim', labels=['Semi', 'Panas', 'Gugur', 'Dingin'])
        ax.set_xlabel("Musim")
        ax.set_ylabel("Total Penyewaan")
